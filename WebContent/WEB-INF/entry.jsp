...
<form action="#" method="post">
	<div class="form-group row">
		...
		<div class="col-2">
			<input type="text" class="form-control" name="day" id="date" placeholder="日付" aria-describedby="dateHelp" value="${param.day}">
		</div>
		<div class="col-4">
		...
		<div class="row">
			...
			<div class="col-sm-8">
				<div class="custom-control custom-radio custom-control-inline">
					<input type="radio" id="division1" name="division" class="custom-control-input" value="minus" ${HtmlUtils.checkDivision(param.division, 'minus') }>
					<label class="custom-control-label" for="division1">支出</label>
				</div>
				<div class="custom-control custom-radio custom-control-inline">
					<input type="radio" id="division2" name="division" class="custom-control-input" value="plus" ${HtmlUtils.checkDivision(param.division, 'plus') }>
	...
	<div class="form-group row">
		...
		<div class="col-4">
			<select class="custom-select" name="category_id" id="category">
				${HtmlUtils.makeOptionCategories(param.category_id)}
			</select>
		</div>
	</div>
	<div class="form-group row">
		...
		<div class="col-6">
			<textarea class="form-control" name="content" id="note" placeholder="備考" rows="3">${param.content}</textarea>
		</div>
	</div>
	<div class="form-group row">
		<label for="amount" class="offset-2 col-sm-2 col-form-label font-weight-bold">金額 <span class="badge badge-danger">必須</span></label>
		<div class="col-2">
			<input type="text" class="form-control" name="cost" id="amount" placeholder="金額" value="${param.cost}">
		</div>
	</div>
